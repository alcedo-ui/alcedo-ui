...
import 'scss/containers/app/modules/layout/ComplicatedTableExamples.scss';

class ComplicatedTableExamples extends Component {
    ...
    render() {
        ...
        return (
            <div className="example complicated-table-examples">
...
export default ComplicatedTableExamples;
