...
class BasePopover extends Component {
    ...
    render() {
        ...
        const {
            ...
            popupClassName = classNames('base-popover', {
                hidden: !enter,
                'base-popover-has-triangle': hasTriangle,
                [`theme-${theme}`]: theme,
                [`base-popover-position-${position}`]: position,
                'base-popover-animated': isAnimated,
                [className]: className
            }),

            popupContentClassName = classNames('base-popover-content', {
            ...
            <Portal visible={!exited}>
                <Transition appear
                    ...
                    <Paper {...restProps}
                        ...
                        {
                            hasTriangle ?
                                <div className="base-popover-triangle-wrapper">
                                    {triangle}
                                </div>
                                :
                                null
...
BasePopover.defaultProps = {
    ...
    visible: false,
    hasTriangle: true,
    triangle: <div className="base-popover-triangle"></div>,
    theme: Theme.DEFAULT,
